...
function addReview(reviews){
  reviews.push({name: 'Meghan', rating: 5, feedback: 'love this place!'});
}
console.log(reviews);
...
console.log(getReviewedByIndex(reviews, 4));
...
function getLastReview(array) {
  return '$(array[array.length -1].name) gave the resturant a $(array[array.length -1].rating), and their feedback was: $(array[array.length -1].feedback}';
} 
